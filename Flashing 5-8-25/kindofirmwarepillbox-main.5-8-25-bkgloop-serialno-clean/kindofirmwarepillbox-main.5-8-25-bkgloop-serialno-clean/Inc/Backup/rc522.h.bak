...
#define cs_reset() 					          HAL_GPIO_WritePin( RFID_NSS_GPIO_Port, RFID_NSS_Pin, GPIO_PIN_RESET )
#define cs_set() 						          HAL_GPIO_WritePin( RFID_NSS_GPIO_Port, RFID_NSS_Pin, GPIO_PIN_SET )
//#define cs_reset() 					          HAL_GPIO_WritePin( PILLBX_HALL_GPIO_Port, PILLBX_HALL_Pin, GPIO_PIN_RESET )
//#define cs_set() 						          HAL_GPIO_WritePin( PILLBX_HALL_GPIO_Port, PILLBX_HALL_Pin, GPIO_PIN_SET )

#define cs2_reset() 					          HAL_GPIO_WritePin( PILLBX_HALL_GPIO_Port, PILLBX_HALL_Pin, GPIO_PIN_RESET )
#define cs2_set() 						          HAL_GPIO_WritePin( PILLBX_HALL_GPIO_Port, PILLBX_HALL_Pin, GPIO_PIN_SET )
