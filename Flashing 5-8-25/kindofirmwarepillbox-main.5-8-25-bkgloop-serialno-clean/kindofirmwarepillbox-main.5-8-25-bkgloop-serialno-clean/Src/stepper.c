...
void startstepper(uint8_t i, uint8_t dir){
	...
	switch (i)
	{
		...
		case 0:
			...
			HAL_GPIO_WritePin(STP1_DIR_GPIO_Port, STP1_DIR_Pin,  (GPIO_PinState)dir);
		...
		case 1:
			...
			HAL_GPIO_WritePin(STP2_DIR_GPIO_Port, STP2_DIR_Pin, (GPIO_PinState)dir);
			HAL_GPIO_WritePin(STP2_EN_GPIO_Port, STP2_EN_Pin, GPIO_PIN_RESET);
		break;
		
		case 3:
			HAL_TIM_PWM_Start_IT(&htim1, TIM_CHANNEL_1);
			HAL_GPIO_WritePin(STP4_DIR_GPIO_Port, STP4_DIR_Pin, (GPIO_PinState) !dir);
			HAL_GPIO_WritePin(STP4_EN_GPIO_Port, STP4_EN_Pin, GPIO_PIN_RESET);
		break;
		case 4:
			
			HAL_TIM_PWM_Start_IT(&htim15, TIM_CHANNEL_1);
			HAL_GPIO_WritePin(STP5_DIR_GPIO_Port, STP5_DIR_Pin,  (GPIO_PinState)!dir);
